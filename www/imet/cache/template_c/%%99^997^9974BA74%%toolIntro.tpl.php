<?php /* Smarty version 2.6.22, created on 2012-07-26 19:35:51
         compiled from admin/toolIntro.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin/toolIntro.tpl', 74, false),)), $this); ?>
...
<br />
			...
			<div style="float:left;padding:0 20px 0 0">
				...
				<?php echo $this->_tpl_vars['form']['fields']['uid']['field']; ?>
<br />
				<?php if ($this->_tpl_vars['form']['fields']['uid']['errMsg']): ?><p class="adminError"><?php echo $this->_tpl_vars['form']['fields']['uid']['errMsg']; ?>
</p><?php endif; ?>
			</div>
			<div class="clear"></div><br />
...
');">
					<td class="odd"><?php echo $this->_tpl_vars['card']['type']; ?>
</td>
					<td class="even"><?php echo $this->_tpl_vars['card']['uid']; ?>
</td>
					<td class="odd"><?php echo $this->_tpl_vars['card']['text']; ?>
</td>
