<?php /* Smarty version 2.6.22, created on 2012-04-25 19:23:28
         compiled from admin/toolSummary.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'cycle', 'admin/toolSummary.tpl', 16, false),)), $this); ?>
...
');">
				<td class="odd"><?php echo $this->_tpl_vars['item']['event']; ?>
</td>
				<td class="even"><?php echo $this->_tpl_vars['item']['description']; ?>
</td>
			</tr>
...
">Back</a>
	...
	<fieldset>
		...
		<?php echo $this->_tpl_vars['form']['fields']['event']['field']; ?>
<br />
		<?php if ($this->_tpl_vars['form']['fields']['event']['errMsg']): ?><p class="adminError"><?php echo $this->_tpl_vars['form']['fields']['event']['errMsg']; ?>
</p><?php endif; ?><br />
		
		<p><strong>Description:</strong></p>
		<?php echo $this->_tpl_vars['form']['fields']['description']['field']; ?>
<br />
		<?php if ($this->_tpl_vars['form']['fields']['description']['errMsg']): ?><p class="adminError"><?php echo $this->_tpl_vars['form']['fields']['description']['errMsg']; ?>
</p><?php endif; ?><br />
